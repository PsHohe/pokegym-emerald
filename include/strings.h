...
extern const u8 gText_Birch_GymTypePrompt[];
...
extern const u8 gText_TrainerCardGymPoints[];
extern const u8 gText_TrainerCardGymRank[];
extern const u8 gText_TrainerCardNextRank[];
extern const u8 gText_PokedollarVar1[];
...
extern const u8 gText_ExpBlockerOn[];
extern const u8 gText_ExpBlockerOff[];
