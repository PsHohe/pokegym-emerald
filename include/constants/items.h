...
enum __attribute__((packed)) Item
{
    ...
    // Charms
    ITEM_OVAL_CHARM = 819,
    ITEM_SHINY_CHARM = 820,
    ITEM_CATCHING_CHARM = 821,
    ITEM_EXP_CHARM = 822,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 823,
    ITEM_GRACIDEA = 824,
    ITEM_REVEAL_GLASS = 825,
    ITEM_DNA_SPLICERS = 826,
    ITEM_ZYGARDE_CUBE = 827,
    ITEM_PRISON_BOTTLE = 828,
    ITEM_N_SOLARIZER = 829,
    ITEM_N_LUNARIZER = 830,
    ITEM_REINS_OF_UNITY = 831,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 832,
    ITEM_Z_POWER_RING = 833,
    ITEM_DYNAMAX_BAND = 834,
    ...
    ITEM_GOOD_ROD = 839,
    ITEM_SUPER_ROD = 840,
    ITEM_DOWSING_MACHINE = 841,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 842,
    ITEM_VS_SEEKER = 843,
    ITEM_TM_CASE = 844,
    ITEM_BERRY_POUCH = 845,
    ITEM_POKEMON_BOX_LINK = 846,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 847,
    ITEM_POWDER_JAR = 848,
    ITEM_WAILMER_PAIL = 849,
    ITEM_POKE_RADAR = 850,
    ITEM_POKEBLOCK_CASE = 851,
    ITEM_SOOT_SACK = 852,
    ITEM_POKE_FLUTE = 853,
    ITEM_FAME_CHECKER = 854,
    ITEM_TEACHY_TV = 855,

    // Story Key Items
    ITEM_SS_TICKET = 856,
    ITEM_EON_TICKET = 857,
    ITEM_MYSTIC_TICKET = 858,
    ITEM_AURORA_TICKET = 859,
    ITEM_OLD_SEA_MAP = 860,
    ITEM_LETTER = 861,
    ITEM_DEVON_PARTS = 862,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 863,
    ITEM_DEVON_SCOPE = 864,
    ITEM_BASEMENT_KEY = 865,
    ITEM_SCANNER = 866,
    ITEM_STORAGE_KEY = 867,
    ITEM_KEY_TO_ROOM_1 = 868,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 869,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 870,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 871,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Pre-Gen VI name
    ITEM_METEORITE = 872,
    ITEM_MAGMA_EMBLEM = 873,
    ITEM_CONTEST_PASS = 874,
    ITEM_PARCEL = 875,
    ITEM_OAKS_PARCEL = ITEM_PARCEL, // Pre-Gen IV name
    ITEM_SECRET_KEY = 876,
    ITEM_BIKE_VOUCHER = 877,
    ITEM_GOLD_TEETH = 878,
    ITEM_CARD_KEY = 879,
    ITEM_LIFT_KEY = 880,
    ITEM_SILPH_SCOPE = 881,
    ITEM_TRI_PASS = 882,
    ITEM_RAINBOW_PASS = 883,
    ITEM_TEA = 884,
    ITEM_RUBY = 885,
    ITEM_SAPPHIRE = 886,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 887,
    ITEM_CLEAR_AMULET = 888,
    ITEM_PUNCHING_GLOVE = 889,
    ITEM_COVERT_CLOAK = 890,
    ITEM_LOADED_DICE = 891,
    ITEM_AUSPICIOUS_ARMOR = 892,
    ITEM_BOOSTER_ENERGY = 893,
    ITEM_BIG_BAMBOO_SHOOT = 894,
    ITEM_GIMMIGHOUL_COIN = 895,
    ITEM_LEADERS_CREST = 896,
    ITEM_MALICIOUS_ARMOR = 897,
    ITEM_MIRROR_HERB = 898,
    ITEM_SCROLL_OF_DARKNESS = 899,
    ITEM_SCROLL_OF_WATERS = 900,
    ITEM_TERA_ORB = 901,
    ITEM_TINY_BAMBOO_SHOOT = 902,

    ITEM_BUG_TERA_SHARD = 903,
    ITEM_DARK_TERA_SHARD = 904,
    ITEM_DRAGON_TERA_SHARD = 905,
    ITEM_ELECTRIC_TERA_SHARD = 906,
    ITEM_FAIRY_TERA_SHARD = 907,
    ITEM_FIGHTING_TERA_SHARD = 908,
    ITEM_FIRE_TERA_SHARD = 909,
    ITEM_FLYING_TERA_SHARD = 910,
    ITEM_GHOST_TERA_SHARD = 911,
    ITEM_GRASS_TERA_SHARD = 912,
    ITEM_GROUND_TERA_SHARD = 913,
    ITEM_ICE_TERA_SHARD = 914,
    ITEM_NORMAL_TERA_SHARD = 915,
    ITEM_POISON_TERA_SHARD = 916,
    ITEM_PSYCHIC_TERA_SHARD = 917,
    ITEM_ROCK_TERA_SHARD = 918,
    ITEM_STEEL_TERA_SHARD = 919,
    ITEM_WATER_TERA_SHARD = 920,

    ITEM_ADAMANT_CRYSTAL = 921,
    ITEM_GRISEOUS_CORE = 922,
    ITEM_LUSTROUS_GLOBE = 923,

    ITEM_BLACK_AUGURITE = 924,
    ITEM_LINKING_CORD = 925,
    ITEM_PEAT_BLOCK = 926,
    ITEM_BERSERK_GENE = 927,

    ITEM_FAIRY_FEATHER = 928,
    ITEM_SYRUPY_APPLE = 929,
    ITEM_UNREMARKABLE_TEACUP = 930,
    ITEM_MASTERPIECE_TEACUP = 931,
    ITEM_CORNERSTONE_MASK = 932,
    ITEM_WELLSPRING_MASK = 933,
    ITEM_HEARTHFLAME_MASK = 934,
    ITEM_HEALTH_MOCHI = 935,
    ITEM_MUSCLE_MOCHI = 936,
    ITEM_RESIST_MOCHI = 937,
    ITEM_GENIUS_MOCHI = 938,
    ITEM_CLEVER_MOCHI = 939,
    ITEM_SWIFT_MOCHI = 940,
    ITEM_FRESH_START_MOCHI = 941,
    ITEM_GLIMMERING_CHARM = 942,
    ITEM_METAL_ALLOY = 943,
    ITEM_STELLAR_TERA_SHARD = 944,

    ITEM_JUBILIFE_MUFFIN = 945,
    ITEM_REMEDY = 946,
    ITEM_FINE_REMEDY = 947,
    ITEM_SUPERB_REMEDY = 948,
    ITEM_AUX_EVASION = 949,
    ITEM_AUX_GUARD = 950,
    ITEM_AUX_POWER = 951,
    ITEM_AUX_POWERGUARD = 952,
    ITEM_CHOICE_DUMPLING = 953,
    ITEM_SWAP_SNACK = 954,
    ITEM_TWICE_SPICED_RADISH = 955,
    ITEM_POKESHI_DOLL = 956,

    ITEM_STRANGE_BALL = 957,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 958,
    ITEM_VICTREEBELITE = 959,
    ITEM_STARMINITE = 960,
    ITEM_DRAGONINITE = 961,
    ITEM_MEGANIUMITE = 962,
    ITEM_FERALIGITE = 963,
    ITEM_SKARMORITE = 964,
    ITEM_FROSLASSITE = 965,
    ITEM_EMBOARITE = 966,
    ITEM_EXCADRITE = 967,
    ITEM_SCOLIPITE = 968,
    ITEM_SCRAFTINITE = 969,
    ITEM_EELEKTROSSITE = 970,
    ITEM_CHANDELURITE = 971,
    ITEM_CHESNAUGHTITE = 972,
    ITEM_DELPHOXITE = 973,
    ITEM_GRENINJITE = 974,
    ITEM_PYROARITE = 975,
    ITEM_FLOETTITE = 976,
    ITEM_MALAMARITE = 977,
    ITEM_BARBARACITE = 978,
    ITEM_DRAGALGITE = 979,
    ITEM_HAWLUCHANITE = 980,
    ITEM_ZYGARDITE = 981,
    ITEM_DRAMPANITE = 982,
    ITEM_FALINKSITE = 983,
    ...
    ITEM_DARKRANITE = 985,
    ITEM_ZERAORITE = 986,
    ITEM_RAICHUNITE_X = 987,
    ITEM_RAICHUNITE_Y = 988,
    ITEM_CHIMECHITE = 989,
    ITEM_ABSOLITE_Z = 990,
    ITEM_STARAPTITE = 991,
    ITEM_GARCHOMPITE_Z = 992,
    ITEM_LUCARIONITE_Z = 993,
    ITEM_GOLURKITE = 994,
    ITEM_MEOWSTICITE = 995,
    ITEM_CRABOMINITE = 996,
    ITEM_GOLISOPITE = 997,
    ITEM_MAGEARNITE = 998,
    ITEM_SCOVILLAINITE = 999,
    ITEM_BAXCALIBRITE = 1000,
