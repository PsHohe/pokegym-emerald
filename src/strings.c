...
const u8 gText_TrainerCardGymPoints[] = _("POINTS");
const u8 gText_TrainerCardGymRank[] = _("RANK");
const u8 gText_TrainerCardNextRank[] = _("NEXT RANK");
...
const u8 gText_ExpBlockerOn[] = _("Exp. gain has been paused.\nYour team will no longer gain Exp.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpBlockerOff[] = _("Exp. gain has been resumed.\nYour team will gain Exp. again.{PAUSE_UNTIL_PRESS}");
